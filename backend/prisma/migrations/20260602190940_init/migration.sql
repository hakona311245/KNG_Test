...
-- CreateEnum
CREATE TYPE "ProductType" AS ENUM ('SHIRT', 'PANT', 'JACKET');

-- CreateEnum
CREATE TYPE "Size" AS ENUM ('S', 'M', 'L', 'XL');

-- CreateEnum
CREATE TYPE "PaymentOption" AS ENUM ('COD', 'VNPAY');
...
-- CreateIndex
CREATE INDEX "Order_paymentOption_idx" ON "Order"("paymentOption");
...
-- CreateIndex
CREATE INDEX "OrderCancellationRequest_customerId_idx" ON "OrderCancellationRequest"("customerId");

-- CreateIndex
CREATE INDEX "OrderCancellationRequest_resolvedAt_idx" ON "OrderCancellationRequest"("resolvedAt");
...
-- AddForeignKey
ALTER TABLE "OrderCancellationRequest" ADD CONSTRAINT "OrderCancellationRequest_orderId_fkey" FOREIGN KEY ("orderId") REFERENCES "Order"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "OrderCancellationRequest" ADD CONSTRAINT "OrderCancellationRequest_customerId_fkey" FOREIGN KEY ("customerId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
